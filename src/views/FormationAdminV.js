    ...
    class FormationAdminV extends View {
        ...
        display() {
            ...
            let createNameFieldFormation = () => {
                ...
                saveIcon.position(nameFieldFormation.width / 2 + 12.5 + MARGIN, 0).dimension(25, 25);
        ...
        displayLibrary() {
            ...
            let createGameLibrary = () => {
                ...
                let createArrowMode = () => {
                    ...
                    svg.addEvent(arrowBorder, 'click', () => {
                        this.toggleArrowMode(arrowBorder)
                    });
                    svg.addEvent(arrowStraight, 'click', () => {
                        this.toggleArrowMode(arrowBorder)
                    });
