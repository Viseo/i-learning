...
function Quizz(title,tabQuestions,color)
{
    ...
    self.display=function(){
        ...
        self.titleBox=self.paper.rect(0,0,self.paper.width,200).attr('fill','rgb('+self.bgColor.r+','+self.bgColor.g+','+self.bgColor.b+')');
        ...
        self.displaySet.push(titleBox);
        self.displaySet.push(titleText);
