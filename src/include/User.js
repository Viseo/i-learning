            ...
            var _checkAndDisplay = () => {
                ...
                check.then(data => {
                    ...
                    if (data.data == 200) {
                        ...
                        _displayField("createPasswordField", this.createPasswordManipulator);
                        _displayField("checkPasswordField", this.checkPasswordManipulator);
