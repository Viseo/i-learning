...
exports.GUI = function() {
    ...
    function formationDisplayFormation() {
        ...
        this.displayGraph = (w, h) => {
            ...
            let manageMiniature = (tabElement) => {
                ...
                if (tabElement instanceof Domain.Quizz) {
                ...
                } else if(tabElement instanceof Domain.Bd) {
    ...
    function playerModeDisplayFormation () {
        ...
        playerMode && Util.Server.getUser(callbackUser);
    }
    ...
    function formationsManagerDisplay() {
        ...
        function onClickFormation(formation) {
            ...
            //!playerMode &&
            Util.Server.getFormationById(formation._id, callbackFormation);
        }
    ...
    var LearningGUI = function (){
        ...
        Domain.Formation.prototype.displayFormationPlayerMode = playerModeDisplayFormation;
