let FLibrary = require('./library').Library;
let FFormationsManager = require('./formationsManager').formationsManager;
...
exports.Domain = function (globalVariables) {
    ...
    let {LibraryVue, GamesLibraryVue, ImagesLibraryVue} = FLibrary(globalVariables, Vue);
