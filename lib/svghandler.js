...
exports.SVG = function(runtime) {
    ...
    class Screen extends DomElement {
        ...
        _draw(){
            svgr.attr(this.component, "left", 0);
            svgr.attr(this.component, "top", 0);
            svgr.attr(this.component, "width", this.width);
            svgr.attr(this.component, "height", this.height);
            svgr.attr(this.component, "position", "relative");
        }
    }
    ...
    class TextItem extends DomElement {
        ...
        _draw(){
            ...
            svgr.attr(this.component, "width", this.width);
            svgr.attr(this.component, "height", this.height);
            svgr.attr(this.component, "text-align", this.anchorText);
            svgr.attr(this.component, "font-family", this.fontName);
            svgr.attr(this.component, "font-size", this.fontSize);
            svgr.attr(this.component, "color", this.fillColor && this.fillColor.length ? "rgb(" + this.fillColor.join(",") + ")" : "none");
            svgr.attr(this.component, "border", this.strokeWidth + "px" || "none");
            svgr.attr(this.component, "outline", "none");
            svgr.attr(this.component, "value", this.messageText);
            svgr.attr(this.component, "placeholder", this.placeHolderText);
            svgr.attr(this.component, "background-color", this.strokeWidth && this.strokeColor && this.strokeColor.length ? "rgb(" + this.strokeColor.join(",") + ")" : "none");
        }
    }
    ...
    class TextArea extends TextItem {
        ...
        static SCROLL = "auto";
        static CLIPPED = "hidden";
        static SHOW_ALL = "visible";
        ...
        _draw(){
            super._draw();
            svgr.attr(this.component, "overflow", this.mode);
            svgr.attr(this.component, "resize", "none");
        }
    }
