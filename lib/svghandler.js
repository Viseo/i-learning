...
exports.SVG = function(runtime) {
    ...
    class TextItem extends DomElement {
        ...
        _draw(style){
            ...
            style += "width:" + this.width + "px;";
            style += "height:" + this.height + "px;";
            style += "text-align:" + this.anchorText + ";";
            style += "font-family:" + this.fontName + ";";
            style += "font-size:" + this.fontSize +";";
            style += "background-color:" + ((this.fillColor && this.fillColor.length) ? "rgb(" + this.fillColor.join(",") + ");" : "none;");
            style += "border:" + this.strokeWidth + "px;" || "none;";
            style += "outline:" + "none;";
            style += "value:" + this.messageText + ";";
            style += "placeholder:" + this.placeHolderText + ";";
            style += "color:" + this.strokeWidth && this.strokeColor && this.strokeColor.length ? "rgb(" + this.strokeColor.join(",") + ");" : "none;";
            svgr.attr(this.component, "style", style);
        }
    }
