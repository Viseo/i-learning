...
describe('SVG gui', function() {
    ...
    describe('Frame tests', function () {
        ...
        function createDraggable(behavior) {
            let draggable = {
                x: 20,
                y: 30,
                move(x, y) {
                ...
                addEvent:(eventName, handler)=>{
                    draggable[eventName] = handler;
                    svg.addEvent(draggable.component, eventName, handler);
                },
                removeEvent:(eventName, handler)=>{
                    draggable[eventName] = handler;
                    svg.removeEvent(draggable.component, eventName, handler);
                }
            };
            Object.assign(draggable, behavior);
            return draggable;
        }
        ...
        it ("plays a drag and drop (move) sequence without any callbacks", function() {
            ...
            let objectToDrag = createDraggable({});
            firstHandler.add(objectToDrag.component);
            frame.installDnD(objectToDrag, {});
            runtime.event(objectToDrag.component.component, "mousedown", {pageX:120, pageY:130});
            assert.equal(firstHandler, objectToDrag.component.parent);
            inspect(objectToDrag.component, {x:20, y:30});
            runtime.event(objectToDrag.component.component, "mousemove", {pageX:140, pageY:140});
            assert.equal(frame.scale, objectToDrag.component.parent);
            inspect(objectToDrag.component, {x:140, y:140});
            runtime.event(objectToDrag.component.component, "mousemove", {pageX:150, pageY:160});
            assert.equal(frame.scale, objectToDrag.component.parent);
            inspect(objectToDrag.component, {x:150, y:160});
            runtime.event(objectToDrag.component.component, "mouseup", {pageX:150, pageY:160});
            assert.equal(firstHandler, objectToDrag.component.parent);
        ...
        it ("plays a drag and drop (click) sequence without any callbacks", function() {
            ...
            assert.equal(firstHandler, objectToDrag.component.parent);
            inspect(objectToDrag.component, {x:20, y:30});
            runtime.event(objectToDrag.component.component, "mouseup", {pageX:120, pageY:130});
            assert.equal(firstHandler, objectToDrag.component.parent);
            inspect(objectToDrag.component, {x:20, y:30});
        });
        ...
        it ("plays a drag and drop (click) sequence with all callbacks on DnD configuration object", function() {
            ...
            assert.equal(3, rEvents.length);
            assert.equal("select true false", rEvents[0]);
            assert.equal("clicked true", rEvents[1]);
        ...
        it ("checks that if select return false, no DnD is done", function() {
            ...
            runtime.event(objectToDrag.component.component, "mousedown", {pageX:120, pageY:130});
            runtime.event(objectToDrag.component.component, "mousemove", {pageX:140, pageY:140});
            runtime.event(objectToDrag.component.component, "mouseup", {pageX:160, pageY:150});
            assert.equal(1, rEvents.length);
            assert.equal("select true false", rEvents[0]);
        });
        ...
        it ("checks if moved fails, revert is invoked", function() {
            ...
            runtime.event(objectToDrag.component.component, "mousedown", {pageX:120, pageY:130});
            runtime.event(objectToDrag.component.component, "mouseup", {pageX:140, pageY:140});
            assert.equal(3, rEvents.length);
        ...
        it ("plays a drag and drop (rotate) sequence without any callbacks", function() {
            ...
            runtime.event(objectToDrag.component.component, "mousedown", {pageX:130, pageY:140});
            inspect(objectToDrag.component, {x:20, y:30, children:[{angle:0}]});
            runtime.event(objectToDrag.component.component, "mousemove", {pageX:120, pageY:150});
            inspect(objectToDrag.component, {x:20, y:30, children:[{angle:45}]});
            runtime.event(objectToDrag.component.component, "mousemove", {pageX:110, pageY:140});
            inspect(objectToDrag.component, {x:20, y:30, children:[{angle:-270}]});
            runtime.event(objectToDrag.component.component, "mouseup", {pageX:110, pageY:140});
            inspect(objectToDrag.component, {x:20, y:30, children:[{angle:-270}]});
        });
        ...
        it ("checks start in drag mode", function() {
            ...
            let rEvents = [];
            frame.installDnD(objectToDrag, {});
            runtime.event(objectToDrag.component.component, "mousemove", {pageX:120, pageY:130});
    ...
    describe('TextPanel tests', function () {
        ...
        describe('Pane and Palette tests', function () {
            ...
            it("handles a pane not included in a palette", function () {
                ...
                let tool1 = new gui.Icons(new svg.Rect(50, 50)).setCallback(callback);
                pane.addTool(tool1).addTool(new gui.Icons(new svg.Rect(50, 50)));
                ...
                pane.addTool(new gui.Icons(new svg.Rect(50, 50)));
                inspect(panel,
                    {tag: "g", transform: "translate(0 90)",
                        children: [
                            {tag: "svg", x: -50, y: -30, width: 100, height: 60,
