...
//                    .execute(completeMovement).moveTo(ps.x, ps.y);
    ...
    class Button {
        ...
        corners(radiusX, radiusY){
            this.back.corners(radiusX, radiusY);
            return this;
        }
    ...
    function installDragAndDrop(what, glass, conf) {
        ...
        let drag = (item, parent, x, y)=> {
            ...
            if (item.component.parent!==glass) {
                item.component.parent.remove(item.component);
                glass.add(item.component);
            }
        ...
        let drop = (item, parent, x, y)=> {
            if (item.component.parent!==parent) {
                item.component.parent.remove(item.component);
        ...
        let install = delta=> {
            ...
            if (!conf.select || conf.select(what, startAngle!=undefined)) {
                ...
                what.addEvent('mousemove', moveEvent=> {
                    let depl = whatParent.localPoint(moveEvent.pageX, moveEvent.pageY);
                    if (startAngle!=undefined) {
                        ...
                        drag(what, whatParent, dragPoint.x, dragPoint.y);
                ...
                what.addEvent('mouseup', endEvent=> {
                    ...
                    let depl = whatParent.localPoint(endEvent.pageX, endEvent.pageY);
                    if (startAngle!=undefined) {
                        ...
                        drop(what, dropEnv.parent, dropEnv.x, dropEnv.y);
        ...
        what.addEvent('mousedown', event=> {
             ...
             */
            install(what.component.parent.localPoint(event.pageX, event.pageY));
            /*
             }
             */
        });
