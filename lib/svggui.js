...
exports.Gui = function(svg, param) {
    ...
    class Puzzle {
        constructor(rows, columns, nbElements) {
            this.rows = rows;
            ...
            this.nbOfVisibleElements = nbElements;
            this.elementsArray = [];
        ...
        drawChevrons(){
            this.leftChevron = new drawChevron((this.chevronSize - this.width)/2, 0, this.chevronSize, this.chevronSize, this.leftChevronManipulator, "left");
            this.rightChevron = new drawChevron((this.width - this.chevronSize)/2, 0 , this.chevronSize, this.chevronSize, this.rightChevronManipulator, "right");
        ...
        fillVisibleElementsArray(orientation){
            //this.indexOfFirstVisibleElement pour définir le point de départ du this.visibleElementsArray à l'aide de this.elementsArray
    ...
    class ScrollablePanel {
        constructor(width, height, color) {
            ...
            this.component = new svg.Translation();
            this.component.focus = this;
            this.border = new svg.Rect(this.width, this.height).color([], 4, [0, 0, 0]);
            this.view = new svg.Drawing(width, height).position(-width/2, -height/2);
            this.translate = new svg.Translation();
            this.component.add(this.view.add(this.translate)).add(this.border);
            this.vHandle = new Handle([[255, 204, 0], 3, [220, 100, 0]], vHandleCallback).vertical(width/2, -height/2, height/2);
