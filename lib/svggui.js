...
//                    .execute(completeMovement).moveTo(ps.x, ps.y);
    ...
    function activeDnD(what, conf, dragManager)
    {
        ...
        let revert = (update) => {
            if (conf.revert) {
                ...
                if (update.angle !== undefined) {
                    ...
                    dragManager.drop.call(dragManager.context || this, what.component, update.parent, update.x, update.y);
                }
            }
        };
            ...
            if (!conf.select || conf.select(what, startAngle != undefined)) {
                ...
                what.addEvent('mousemove', moveEvent => {
                    ...
                    if (startAngle != undefined) {
                        ...
                        dragManager.drag.call(dragManager.context || this,what.component, whatParent, dragPoint.x, dragPoint.y);
                ...
                what.addEvent('mouseup', endEvent => {
                    ...
                    if (startAngle != undefined) {
                        ...
                        dragManager.drop.call(dragManager.context || this,what.component, dropEnv.parent, dropEnv.x, dropEnv.y);
