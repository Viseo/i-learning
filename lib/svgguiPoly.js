...
exports.guiPolyfill = function (svg, gui, Handlers, runtime) {
    ...
    let tmp = gui.Button;
    gui.Button = (function(button){
         return extend(function(){
             let tmpButton = new tmp(...arguments);
             svg.addEvent(tmpButton.glass,'mouseenter', ()=>{svgr.attr(svgr.drawing.component, 'style', 'cursor:pointer');})
             svg.addEvent(tmpButton.glass,'mouseleave', ()=>{svgr.attr(svgr.drawing.component, 'style', 'cursor:auto');})
             return (function(){return tmpButton})();
         }, gui.Button);
    }(gui.Button))
