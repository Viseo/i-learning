...
var myColorsOld = function(db, callback) {
    db.collection('Formation').insert({
        ...
        assert.equal(err);
        console.log("Inserted a document myColorsOld into the Formation collection.");
        callback();
    });
};
...
var myColors = function(db, callback) {
    db.collection('Formation').insert({
    darkBlue: [25, 25, 112],
    blue:[25, 122, 230],
    primaryBlue:[0, 0, 255],
    ...
    none:[]
        ...
        assert.equal(err);
        console.log("Inserted a document myColors into the Formation collection.");
        callback();
    });
};
...
var myBibImage = function(db, callback) {
    db.collection('Formation').insert({
        ...
        assert.equal(err);
        console.log("Inserted a document myBibImage into the Formation collection.");
        callback();
    });
};

var defaultQuestion = function(db, callback) {
    db.collection('Formation').insert({
    ...
    rows: 4, colorBordure: myColors.black, bgColor: myColors.white
        ...
        assert.equal(err);
        console.log("Inserted a document defaultQuestion into the Formation collection.");
        callback();
    });
};

var defaultQuizz = function(db, callback) {
    db.collection('Formation').insert({
    title: "",
    ...
    tabQuestions: [defaultQuestion]
        ...
        assert.equal(err);
        console.log("Inserted a document defaultQuizz into the Formation collection.");
        callback();
    });
};

var questionWithLabelImageAndMultipleAnswers = function(db, callback) {
    db.collection('Formation').insert({
    ...
    rows: 2, colorBordure: myColors.primaryBlue, bgColor: myColors.green
        ...
        assert.equal(err);
        console.log("Inserted a document questionWithLabelImageAndMultipleAnswers into the Formation collection.");
        callback();
    });
};

var myQuestion2 = function(db, callback) {
    db.collection('Formation').insert({
    ...
    rows: 2, colorBordure: myColors.primaryBlue, bgColor: myColors.purple
        ...
        assert.equal(err);
        console.log("Inserted a document myQuestion2 into the Formation collection.");
        callback();
    });
};

var myQuizzTest = function(db, callback) {
    db.collection('Formation').insert({
    ...
    assert.equal(err);
    console.log("Inserted a document myQuizzTest into the Formation collection.");
    callback();
});
};

var myQuizz = function(db, callback) {
    db.collection('Formation').insert({
    title: "Qui veut gagner des millions ? Quizz n°1",
    bgColor: myColors.raspberry,
    puzzleLines: 3,
    ...
    assert.equal(err);
    console.log("Inserted a document myQuizz into the Formation collection.");
    callback();
});
};

var myQuizzDemo = function(db, callback) {
    db.collection('Formation').insert({
    title: "Qui veut gagner des millions ? Quizz n°1",
    tabQuestions: [
        {
    ...
    assert.equal(err);
    console.log("Inserted a document myQuizzDemo into the Formation collection.");
    callback();
});
};
...
var myQuizzType = function(db, callback) {
    db.collection('Formation').insert({
    ...
    tab: [{
        ...
        assert.equal(err);
        console.log("Inserted a document myQuizzType into the Formation collection.");
        callback();
    });
};
...
var myFormations = function(db, callback) {
    db.collection('Formation').insert({
    ...
    assert.equal(err);
    console.log("Inserted a document myFormations into the Formation collection.");
    callback();
});
};

var myBibJeux = function(db, callback) {
    db.collection('Formation').insert({
    title: "Type de jeux",
    tabLib: [
        {label: "Quiz"},
    ...
    assert.equal(err);
    console.log("Inserted a document myBibJeux into the Formation collection.");
    callback();
});
};
